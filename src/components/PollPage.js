...
const PollPage = ({ dispatch, id, authedUser, questions }) => {
  ...
  const optionOne = question.optionOne.votes.includes(authedUser.id);
  const optionTwo = question.optionTwo.votes.includes(authedUser.id);
  ...
  return (
    <div className="containerPoll">
      ...
      <img src={authedUser.avatarURL} alt="Profile" className="rounded-circle img-fluid w-5 p-4" />
